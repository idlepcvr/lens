...
|---|---|---|---|
| `TREND_4R_v1` | **ready to test** | TBD | **Current focus.** 4H with-trend, fixed 1% stop / 4% TP (4R). Built to the locked thesis (see `docs/prism-system-spec.md`). Tests whether 4R is reachable at a 1% stop. |
