"""LENS /desk-old — the PRE-redesign desk, kept for before/after comparison.

Exact original markup (desktop-oriented, read-only, no action buttons). Served at
/desk-old. Safe to delete once the new cockpit is signed off.
"""
...
<div class="app">
  <div class="topbar">
    <div class="brand">
      ...
      <div class="brand-meta">can I enter right now? (OLD)</div>
    </div>
    <nav class="topnav">
      <a href="/">Dashboard</a>
      <a href="/desk">Desk (new)</a>
      <a href="/desk-old" class="cur">Desk (old)</a>
