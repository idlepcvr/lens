...
// Row click navigates to the unified trade-detail page (/chart-review) —
// this used to open a modal with its own small chart + grading form that
// duplicated (and drifted from) that page. Direct ask: "the review chart
// and review should almost be the same" — now there is only one.
function openTrade(id){
  location.href='/chart-review?trade='+id+'&book='+BOOK;
}
